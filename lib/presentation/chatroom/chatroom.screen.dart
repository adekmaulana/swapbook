              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: controller.other.value.photoURL ?? '',
                  ...
                  builderDelegate: PagedChildBuilderDelegate<Message>(
                    ...
                    itemBuilder: (context, message, index) {
                        ...
                        return Column(
                          children: [
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                text: message.userId == controller.self.value.id
                                    ? 'You'
                            ...
                            if (message.userId != controller.self.value.id)
                              const SizedBox(height: 16),
                            if (message.userId != controller.self.value.id)
                      ...
                      return Container(
                        ...
                        child: Column(
                          crossAxisAlignment:
                              message.userId == controller.self.value.id
